...
#define SYREEN_CREW_WIDTH  (8)
#define SYREEN_CREW_HEIGHT (8)


u16 syreen_crewData[] =
{
   0xEBEB, 0xEBEB, 0xEBEB, 0xEBEB, 0xEBEB, 0xEBEB, 0xEBEB, 0xEBEB, 0xEBEB, 0xEBEB, 
   0xEBEB, 0xEBEB, 0xEBEB, 0xEBEB, 0x00AB, 0xEBEB, 0xEBEB, 0xEBEB, 0x00EB, 0xEBEB, 
   0xEBEB, 0xEBEB, 0xEBEB, 0xEBEB, 0xEBEB, 0xEBEB, 0x00EB, 0x00EB, 0xEBEB, 0xEBEB, 
   0xDAEB, 0xEBEB, 
};

#define SYREEN_CREW_SIZE (32)


u16 syreen_crewPalette[] =
{
