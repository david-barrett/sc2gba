...
#define CREW7_WIDTH  (8)
#define CREW7_HEIGHT (8)


u16 crew7Data[] =
{
   0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xC000, 0xC000, 0xC000, 0x0000, 0xC000, 
   0xC000, 0xC000, 0x0000, 0x0000, 0xEB00, 0xEB00, 0xC000, 0xC000, 0xC000, 0xC000, 
   0xC000, 0xC000, 0xAB00, 0xC0E4, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 
   0x0000, 0x0000, 
};

#define CREW7_SIZE (32)
