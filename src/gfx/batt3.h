...
u16 batt3Data[] =
{
   ...
   0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00D0, 0xB9D0, 0x0000, 0x0000, 
   0x00D0, 0x00D0, 0x0000, 0x00B9, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 
   0x0000, 0x0000, 
};

#define BATT3_SIZE (32)
...
u16 batt3Palette[] =
{
   ...
   0x0001, 0x7BDF, 0x0000, 0x7FDF, 0x0000, 0x0000, 0x64D3, 0x64D9, 0x64DF, 0x6580, 
   0x6586, 0x4D8C, 0x6593, 0x6599, 0x4D9F, 0x6660, 0x6666, 0x666C, 0x6673, 0x6679, 
   0x667F, 0x6720, 0x6726, 0x672C, 0x6733, 0x6739, 
};
