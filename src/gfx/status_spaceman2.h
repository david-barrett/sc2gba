...
#define STATUS_SPACEMAN2_WIDTH  (8)
#define STATUS_SPACEMAN2_HEIGHT (8)


u16 status_spaceman2Data[] =
{
   0xEBEB, 0xEBEB, 0xEBEB, 0xEBEB, 0xEBEB, 0xEBEB, 0xEBEB, 0xEBEB, 0xEBEB, 0xEBEB, 
   0xEBEB, 0xEBEB, 0xEBEB, 0xEBB0, 0xEBEB, 0xEBB0, 0xB0EB, 0xB008, 0xB0EB, 0xB008, 
   0x51EB, 0xE6C6, 0x51EB, 0xDFC6, 0xB0EB, 0xBE51, 0x7BE8, 0xBE51, 0xEBEB, 0x00EB, 
   0x00EB, 0xEBEB, 
};

#define STATUS_SPACEMAN2_SIZE (32)


u16 status_spaceman2Palette[] =
{
   ...
   0x0001, 0x7BDF, 0x0000, 0x7FDF, 0x0000, 0x0000, 0x7FC1, 0x008F, 0x5695, 0x7C01, 
   0x02BC, 0x03C1, 0x00B9, 0x237C, 0x025F, 0x0413, 0x007C, 0x002D, 0x1806, 0x62F0, 
   0x1A59, 0x6018, 0x0179, 0x0300, 0x00D3, 0x0020, 
};
