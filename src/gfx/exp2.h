...
#define EXP2_WIDTH  (8)
#define EXP2_HEIGHT (8)


u16 exp2Data[] =
{
   0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xB000, 0xB0B0, 0x0000, 0x0000, 0x73B0, 
   0x738F, 0x00B0, 0x0000, 0x8FD0, 0xA182, 0x00B0, 0x0000, 0x73B0, 0x73A1, 0x00B0, 
   0x0000, 0xB000, 0x7BB0, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 
   0x0000, 0x0000, 
};
...
u16 exp2Palette[] =
{
   ...
   0x0001, 0x7BDF, 0x0000, 0x7FDF, 0x0000, 0x0000, 0x4210, 0x001F, 0x03E0, 0x03FF, 
   0x7C00, 0x7C1F, 0x7FE0, 0x7FFF, 0x4FF9, 0x47D5, 0x47D5, 0x3820, 0x640C, 0x6413, 
   0x6419, 0x4CC0, 0x64C6, 0x64CC, 0x64D3, 0x64D9, 
};
