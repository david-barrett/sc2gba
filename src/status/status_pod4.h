...
#define STATUS_POD4_WIDTH  (8)
#define STATUS_POD4_HEIGHT (8)


u16 status_pod4Data[] =
{
   0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xC500, 0x00C5, 
   0xC500, 0x00C5, 0xC500, 0x00C5, 0xC500, 0x00C5, 0x0000, 0x0000, 0x0000, 0x0000, 
   0xC500, 0x00C5, 0xC500, 0x00C5, 0xC500, 0x00C5, 0xC500, 0x00C5, 0x0000, 0x0000, 
   0x0000, 0x0000, 
};

#define STATUS_POD4_SIZE (32)


u16 status_pod4Palette[] =
{
