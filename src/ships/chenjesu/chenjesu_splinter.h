...
#define CHENJESU_SPLINTER_WIDTH  (8)
#define CHENJESU_SPLINTER_HEIGHT (8)


u16 chenjesu_splinterData[] =
{
   0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x5151, 
   0x5151, 0x0051, 0x0000, 0x5151, 0x5151, 0x0051, 0x0000, 0x5151, 0x5151, 0x0000, 
   0x0000, 0x5151, 0x5151, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 
   0x0000, 0x0000, 
};

#define CHENJESU_SPLINTER_SIZE (32)


u16 chenjesu_splinterPalette[] =
{
